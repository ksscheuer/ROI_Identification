...
knitr::opts_knit$set(root.dir = "G:/My Drive/Jackson/PhotoZ_data/Step1_ROIs/2020-05-29_SS_notUsable/01-01and01-02")
...
def check_cell(x, y, group_index, color, rdepth):
  ...
  if (cell_value != 0 and 
    ...
    if(rdepth >= rlimit):
      ...
      return None
    rdepth += 1
    #print ("rdepth",rdepth,"x",x,"y",y,"index",group_index,"value",cell_value,"cluster",cluster_results[y][x])
...
# plt.title("ROIs with Diameter <= Cutoff - Date: %s, Slice: %s, Diameter: %d" % (mydate,myslice,ROI_diameter_cutoff))
plt.show()
...
plt.title("Date: %s, Slice: %s, Diameter Cutoff: %d" % (mydate,myslice,ROI_diameter_cutoff),fontsize=13)
# plt.title("ROIs with Electrode - Date: %s, Slice: %s" % (mydate,myslice))
plt.show()
...
# plt.title("ROIs Not Touching Electrode - Date: %s, Slice: %s" % (mydate,myslice))
plt.show()
...
plt.title("Date: %s, Slice: %s" % (mydate,myslice),fontsize=13)
# plt.title("ROIs Not Touching - Date: %s, Slice: %s" % (mydate,myslice))
plt.show()
...
# plt.title("ROIs with SNR > Cutoff - Date: %s, Slice: %s, SNR Cutoff: %d" % (mydate,myslice,SNRcutoff))
plt.show()
...
plt.title("Date: %s, Slice: %s, SNR Cutoff: %d" % (mydate,myslice,SNRcutoff),fontsize=13)
# plt.title("Final ROIs - Date: %s, Slice: %s, SNR Cutoff: %d" % (mydate,myslice,SNRcutoff))
plt.show()
