...
knitr::opts_knit$set(root.dir = "G:/My Drive/Jackson/PhotoZ_data/Step1_ROIs/2020-06-01_SS/05-01")
...
# cell_value != 0 and cluster_results[y][x] == 0 and (color == 0 or cell_value == color)
# cluster_results[y][x] = group_index
# my_bound = [x,x,y,y]
# xleft = max(0, x-1) #x coordinate of pixel to L
# xright = min(width-1, x+1) #x coordinate of pixel to R
...
# 
# check_cell(xright,y,group_index,cell_value)
# # print (child_bound)
# cell_value = pixel_cluster_data[y][xright]
# print ("cell_value xright",cell_value)
# cell_value != 0 and cluster_results[y][xright] == 0 and (color == 0 or cell_value == color)
# my_bound = combine_bound(my_bound,child_bound)
# print (my_bound)
...
# print (child_bound)
# print (my_bound)
# # cell_value = pixel_cluster_data[y][xleft]
# # print ("cell_value xleft",cell_value)
# # cell_value != 0 and cluster_results[y][xleft] == 0 and (color == 0 or cell_value == color)
# # my_bound = combine_bound(my_bound,child_bound)
# # print (my_bound)
# child_bound = check_cell(x,ydown,group_index,cell_value)
# cell_value = pixel_cluster_data[ydown][x]
# print ("cell_value ydown",cell_value)
# cell_value != 0 and cluster_results[ydown][x] == 0 and (color == 0 or cell_value == color)
# my_bound = combine_bound(my_bound,child_bound)
# print (my_bound)
#     my_bound = combine_bound(my_bound,child_bound)
#     child_bound = check_cell(xright,y,group_index,cell_value)
