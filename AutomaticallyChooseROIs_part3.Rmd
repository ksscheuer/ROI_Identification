...
knitr::opts_knit$set(root.dir = "G:/My Drive/Jackson/PhotoZ_data/Step1_ROIs/2020-08-03_ACC/01-01_ToDo")
...
def check_cell(x, y, group_index, color, rdepth):
  ...
  if (cell_value != 0 and 
    ...
    if(rdepth >= rlimit):
      print ("HIT RECURSION LIMIT OF {} AT CELL {} {} RESULTS INNACURATE.".format(rlimit, x,y))
      return None
    rdepth += 1
