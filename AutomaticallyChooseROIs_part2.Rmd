...
knitr::opts_knit$set(root.dir = "G:/My Drive/Jackson/Neuroplex_data/Analyzed_with_PhotoZ/Step1_ROIs/2019-06-26_SS_FXR1/03-01")
...
################## Keep only n ROIs with highest SNR #######################
############################################################################
...
r.roi_average = roi_averages
n_ROIs_highest_SNR = r.n_ROIs_highest_SNR

roi_averages_to_keep = numpy.unique(roi_averages)[range(numpy.unique(roi_averages).size-(int(n_ROIs_highest_SNR)),numpy.unique(roi_averages).size)]

# top_roi_averages = numpy.zeros((width,height))
# 
# for i in range(0,width):
#   for j in range(0,height):
#     if roi_averages[x][y] in roi_averages_to_keep:
#       top_roi_averages[x][y] = roi_averages[x][y]
# plt.matshow(top_roi_averages)
# plt.show()
...
roi_averages[roi_averages < roi_averages_to_keep[0]] = 0
r.roi_averages = roi_averages
r.roi_averages = roi_averages[roi_averages >= roi_averages_to_keep[0]]
...
plt.savefig("Step7_%d_ROI_with_Highest_SNR.jpg" % n_ROIs_highest_SNR,fontsize=13)
