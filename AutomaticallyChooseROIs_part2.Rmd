...
knitr::opts_knit$set(root.dir = "G:/My Drive/Jackson/Neuroplex_data/Analyzed_with_PhotoZ/Step1_ROIs/2019-06-27_SS_FXR1/04-01_FIX_ELECTRODE_ROI")
...
# 
# if numpy.unique(roi_averages).size > 15: #if at least 15 ROIs left after step 6
#   roi_averages_to_keep = numpy.unique(roi_averages)[range(numpy.unique(roi_averages).size-(int(n_ROIs_highest_SNR)),numpy.unique(roi_averages).size)]
...
#   plt.matshow(roi_averages)
#   plt.suptitle("Step 7. %d ROIs with Highest SNR" % n_ROIs_highest_SNR,fontsize=15)
#   plt.title("Date: %s, Slice: %s" % (mydate,myslice),fontsize=13)
#   plt.show()
#   plt.savefig("Step7_%d_ROI_with_Highest_SNR.jpg" % n_ROIs_highest_SNR,fontsize=13)
# else:
#   r.roi_averages = roi_averages
#   nrois = numpy.unique(roi_averages).size-1
#   plt.matshow(roi_averages)
#   plt.suptitle("Step 7. %d ROIs with Highest SNR" % nrois,fontsize=15)
#   plt.title("Date: %s, Slice: %s" % (mydate,myslice),fontsize=13)
#   plt.show()
#   plt.savefig("Step7_%d_ROI_with_Highest_SNR.jpg" % nrois,fontsize=13)
