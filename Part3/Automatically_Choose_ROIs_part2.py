...
# print(cluster_results)
# print(np.amin(cluster_results),np.amax(cluster_results))
# index_list = range()
...
plot_cluster_results = np.ndarray.copy(cluster_results)
plot_cluster_results[plot_cluster_results==0] = np.nan
# print(plot_cluster_results)

# cluster_results[cluster_results==0] = np.nan
# print(cluster_results)
...
plt.set_cmap("hsv")
# plt.set_cmap('tab20') #hsv, hot, jet, inferno, magma, plasma, viridis, BrBG, PiYG,PRGn,PuOr,RdBu,RdGy,RdYlBu,RdYlGn,
#                     #Spectral, Blues, BuGn, BuPu, GnBu, Greens, **Greys**, Oranges, OrRd, PuBu, PuBuGn,PuRd, Purples,
#                     #Reds,YlGn, YlGnBu, YlOrBr, YlOrRd, autumn, bone, cool copper,**flag**, gray, hot, jet, pink,
#                     #**prism**,spring,summer, winter, Pastel1, Pastel2, Paired, Accent, Dark2, Set1, Set2, Set3,
...
# produce_dat_files(width=width,height=height,trace_data=plot_cluster_results,n_rois_per_file=50,dat_file_name="All_Potential_ROIs_")
#
############################################### Add electrode ##########################################################
...
#
# # produce_dat_files(width=width,height=height,trace_data=plot_cluster_results,n_rois_per_file=50,dat_file_name="ROIs_Diameter_Within_Cutoff_")
#
# # print(cluster_results)
#
...
# electrode_cluster = 0.002 #does plot electrode just really hard to see against background
...
# #     # gradient = np.vstack((gradient, gradient))
# #     # plt.axes().set(facecolor="orange")
# #     plt.matshow(cluster_results,vmin=0,vmax=2)
# #     # print(cluster_results)
# #     # plt.matshow(cluster_results)
# #     plt.title("ROIs with SNR > Cutoff",fontsize=13)
# #     # plt.show()
